        ...
        if(friendStatus == Constant.FRIEND_STATUS.REQUESTING){
            if(resultFriend.length > 0 && resultFriend[0].friendStatus == Constant.FRIEND_STATUS.FRIEND){
                ...
                accountFriendService.deletePairNoFriend(accountId, friendId).then(function(resultDelete){
                    ...
                    friendMakeTo.friendStatus = Constant.FRIEND_STATUS.PENDING;
...
router.post('/getFriendList', [accessTokenService.checkAccessToken, function(req, res, next) {
    ...
    if(friendStatus != Constant.FRIEND_STATUS.FRIEND && friendStatus != Constant.FRIEND_STATUS.REQUESTING && friendStatus != Constant.FRIEND_STATUS.PENDING
